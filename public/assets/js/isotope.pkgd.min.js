...
(function (n) {
        ...
        function u(t) {
            t.prototype.option ||
                (t.prototype.option = function (t) {
                    n.isPlainObject(t) &&
                        (this.options = n.extend(!0, this.options, t));
                });
        }
        function f(r, u) {
            n.fn[r] = function (f) {
                ...
                if (typeof f == "string") {
                    for (
                        h = i.call(arguments, 1), o = 0, c = this.length;
                        o < c;
                        o++
                    ) {
                ...
                return this.each(function () {
                    ...
                    t
                        ? (t.option(f), t._init())
                        : ((t = new u(this, f)), n.data(this, r, t));
                });
            };
        }
        if (n) {
    ...
    typeof define == "function" && define.amd
        ? define("jquery-bridget/jquery.bridget", ["jquery"], t)
        : t(n.jQuery);
})(window);
/*!
 * eventie v1.0.5
...
(function (n) {
    ...
    function u(n) {
        var o = n.type === "readystatechange" && i.readyState !== "complete",
            ...
            e;
        if (!t.isReady && !o)
            for (t.isReady = !0, u = 0, f = r.length; u < f; u++)
                (e = r[u]), e();
    }
    function f(r) {
        return (
            r.bind(i, "DOMContentLoaded", u),
    ...
    t.isReady = !1;
    typeof define == "function" && define.amd
        ? ((t.isReady = typeof requirejs == "function"),
          define("doc-ready/doc-ready", ["eventie/eventie"], f))
        : (n.docReady = f(n.eventie));
})(this);
/*!
...
(function () {
    ...
    n.addListener = function (n, t) {
        ...
        for (var r in i)
            i.hasOwnProperty(r) &&
                u(i[r], t) === -1 &&
                i[r].push(f ? t : { listener: t, once: !1 });
        return this;
    };
    n.on = i("addListener");
...
(function (n) {
    function t(n) {
        ...
        if (n) {
            ...
            for (
                n = n.charAt(0).toUpperCase() + n.slice(1), t = 0, f = i.length;
                t < f;
                t++
            )
    ...
    (function (n, t) {
        ...
        function s(n, t) {
            var r, i, u;
            for (
                f(n), r = n.parentNode.querySelectorAll(t), i = 0, u = r.length;
                i < u;
                i++
            )
                if (r[i] === n) return !0;
        ...
        var u = (function () {
                ...
                for (
                    i = ["webkit", "moz", "ms", "o"], n = 0, u = i.length;
                    n < u;
                    n++
                )
                    if (((f = i[n]), (r = f + "MatchesSelector"), t[r]))
                        return r;
            })(),
            i,
            e,
        ...
        function i(n, t, i) {
            ...
            return (
                ...
                (o.prototype.transition =
                    o.prototype[s ? "_transition" : "_nonTransition"]),
                ...
                (o.prototype.ontransitionend = function (n) {
                    ...
                    n.target === this.element &&
                        ...
                        i in t.clean &&
                            ((this.element.style[n.propertyName] = ""),
                            delete t.clean[i]),
                        i in t.onEnd &&
                            ((r = t.onEnd[i]), r.call(this), delete t.onEnd[i]),
...
(function (n) {
    ...
    function h(h, c, l, a, y, p) {
        function w(n, t) {
            if (
                (typeof n == "string" && (n = e.querySelector(n)), !n || !f(n))
            ) {
                r &&
                    r.error(
                        "Bad " + this.constructor.namespace + " element: " + n
                    );
                return;
            }
            this.element = n;
        ...
        return (
            ...
            (w.prototype._layoutItems = function (n, t) {
                ...
                for (
                    this._itemsOn(n, "layout", o), f = [], i = 0, s = n.length;
                    i < s;
                    i++
                )
                    (r = n[i]),
            ...
            (w.prototype._itemsOn = function (n, t, i) {
                ...
                for (
                    var f, u = 0, e = n.length, o = this, r = 0, h = n.length;
                    r < h;
                    r++
                ) {
                    f = n[r];
            ...
            (w.prototype.unstamp = function (n) {
                ...
                if (((n = this._find(n)), n))
                    for (t = 0, r = n.length; t < r; t++)
                        (i = n[t]), s(i, this.stamps), this.unignore(i);
            }),
            ...
            (w.prototype._manageStamps = function () {
                ...
                if (this.stamps && this.stamps.length)
                    for (
                        this._getBoundingRect(), n = 0, t = this.stamps.length;
                        n < t;
                        n++
                    )
                        (i = this.stamps[n]), this._manageStamp(i);
            }),
            ...
            (w.prototype.bindResize = function () {
                this.isResizeBound ||
                    (h.bind(n, "resize", this), (this.isResizeBound = !0));
            }),
            ...
            (w.prototype.getItems = function (n) {
                var i, t, u, f, r;
                if (n && n.length) {
                    for (i = [], t = 0, u = n.length; t < u; t++)
                        (f = n[t]), (r = this.getItem(f)), r && i.push(r);
                    return i;
                }
            }),
    ...
    (function (n) {
        ...
        typeof define == "function" && define.amd
            ...
            : ((n.Isotope = n.Isotope || {}), (n.Isotope.Item = t(n.Outlayer)));
    })(window),
    (function (n) {
        function t(n, t) {
            function i(n) {
                this.isotope = n;
                n &&
                    ((this.options = n.options[this.namespace]),
            ...
            return (
                ...
                (i.prototype.getSegmentSize = function (n, t) {
                    var i = n + t,
                        u = "outer" + t,
                        r;
                    (this._getMeasurement(i, u), this[i]) ||
                        ((r = this.getFirstItemSize()),
                        (this[i] =
                            (r && r[u]) || this.isotope.size["inner" + t]));
                }),
            ...
            (r.prototype._manageStamp = function (n) {
                ...
                for (
                    f = Math.max(0, f),
                        ...
                        h =
                            (this.options.isOriginTop ? u.top : u.bottom) +
                            e.outerHeight,
                        r = f;
                    r <= i;
                    r++
...
(function (n) {
    ...
    typeof define == "function" && define.amd
        ...
        : t(n.Isotope.LayoutMode, n.Masonry);
})(window),
    (function (n) {
        function t(n) {
        ...
        function t(n) {
            ...
            return (
                ...
                (t.prototype._getItemLayoutPosition = function (n) {
                    n.getSize();
                    var t =
                            (this.isotope.size.innerWidth - n.size.outerWidth) *
    ...
    function r(n, r, e, s, h) {
        ...
        return (
            ...
            (c.prototype._itemize = function () {
                for (
                    var r,
                        t = n.prototype._itemize.apply(this, arguments),
                        i = 0,
                        u = t.length;
                    i < u;
                    i++
                )
                    (r = t[i]), (r.id = this.itemGUID++);
            ...
            (c.prototype._filter = function (n) {
                ...
                for (i = 0, h = n.length; i < h; i++)
                    ((t = n[i]), t.isIgnored) ||
                        ...
                        r && t.isHidden
                            ? o.push(t)
                            : r || t.isHidden || s.push(t));
                return (
                    (f = this), this._isInstant ? this._noTransition(c) : c(), e
                );
            }),
            ...
            (c.prototype._sort = function () {
                var n = this.options.sortBy,
                    ...
                    i;
                n &&
                    ((t = [].concat.apply(n, this.sortHistory)),
            ...
            (c.prototype.insert = function (n) {
                ...
                if (i.length) {
                    for (r = i.length, t = 0; t < r; t++)
                        (f = i[t]), this.element.appendChild(f.element);
                    for (
                        u = this._filter(i),
